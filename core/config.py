...
class Config:
    def __init__(self, jira_url: str, jira_username: Optional[str], jira_api_token: str, jira_is_cloud: Optional[str], gh_token: str, project_dir: str, jira_base_issue: str):
